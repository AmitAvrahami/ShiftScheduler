                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
                    ...
                    <div className="lg:col-span-1 flex flex-col gap-4">
                        ...
                        >
                            ...
                            <div>
                                <h4 className="font-bold text-slate-800 text-base mb-0.5">סדר עורכים שלי</h4>
                                <p className="text-xs text-slate-500 font-medium tracking-wide">התאמה אישית של תצוגה</p>
                            </div>
                        </button>
                    </div>
